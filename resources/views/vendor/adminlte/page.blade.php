...
@section('adminlte_css')
    <link rel="stylesheet" href="{!! asset('static/admin/assets/css/adminlte.css') !!}">
    @stack('css')
    @yield('css')
@stop
                                    ...
                                    @if(config('adminlte.usermenu_enabled'))
                                        <li class="nav-item dropdown user-menu">
                                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                                                ...
                                                @endif
                                                <span
                                                    @if(config('adminlte.usermenu_image'))class="d-none d-md-inline"@endif>{{ Auth::user()->name }}</span>
                                            </a>
                                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                ...
                                                @can('loja')
                                                    <li class="user-footer">
                                                        ...
                                                        href="{!! route('admin.mystore.index') !!}">
                                                            <i class="fa fa-fw fa-power-off"></i> {{ __('Edit store') }}
                                                        </a>
                                                    </li>
                                                @endcan
                                                ...
                                                <li class="user-footer">
                                                    ...
                                                    <a id='btn-action-logout'
                                                       class="btn btn-default btn-flat float-right @if(!$profile_url)btn-block @endif"
                                                       href="#"
                                        ...
                                        <div class='card-body'>
                                            @if (!empty($routeIndex))
                                                <div class='form-group'>
                                                    <a id='relatorio' class='btn btn-secondary'
                                                       href="{!! $routeIndex !!}">
                                                        Relatório
                                                    </a>
                                                </div>
